...
public class ArticleLoader extends CursorLoader {
    public static Loader<Cursor> newAllArticlesInstance(Context context) {
        return new ArticleLoader(context, ItemsContract.Items.buildDirUri()); // chose to implement Option 2
    }

    public static Loader<Cursor> newInstanceForItemId(Context context, long itemId) {
        return new ArticleLoader(context, ItemsContract.Items.buildItemUri(itemId)); // chose to implement Option 2
    }
